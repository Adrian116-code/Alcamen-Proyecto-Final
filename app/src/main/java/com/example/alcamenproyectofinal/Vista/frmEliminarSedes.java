...
public class frmEliminarSedes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_frm_eliminar_sedes);
    ...
    public void btnEliminarSede(View view){
        ...
        Sede sedeEncontrado = db.sedeDao().obtenerPorId(codigoAEliminar);

        if (sedeEncontrado != null) {
            db.sedeDao().eliminarSede(sedeEncontrado);
            Toast.makeText(this, "Sede eliminado con éxito", Toast.LENGTH_LONG).show();
